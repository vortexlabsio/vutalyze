...
export async function action({ request }: ActionArgs) {
	...
	const response = await sendEmail({
		to: user.email,
		subject: `Vutalyze Password Reset`,
		...
		<html>
			...
			<body>
				<h1>Reset your Vutalyze password.</h1>
				<p>Click the link below to reset the Vutalyze password for ${user.username}.</p>
...
export const meta: MetaFunction = () => {
	return {
		title: 'Password Recovery for Vutalyze',
	}
}
